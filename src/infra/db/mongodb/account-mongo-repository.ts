...
import { type AddAccountRepository, type LoadAccountByEmailRepository, type CheckAccountByEmailRepository, type UpdateAccessTokenRepository, type LoadAccountByTokenRepository } from '~/data/protocols'
