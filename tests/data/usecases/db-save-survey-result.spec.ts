...
import { type SaveSurveyResultRepository, type LoadSurveyResultRepository } from '~/data/protocols'

import { throwError, mockSurveyResultModel, mockSaveSurveyResultParams } from '~/tests/domain/mocks'
